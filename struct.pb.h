...
class ListValue :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Value >*
      mutable_values();
  private:
  const ::google::protobuf::Value& _internal_values(int index) const;
  ::google::protobuf::Value* _internal_add_values();
  public:
...
inline const ::google::protobuf::Value& ListValue::_internal_values(int index) const {
...
inline ::google::protobuf::Value* ListValue::_internal_add_values() {
  return values_.Add();
}
